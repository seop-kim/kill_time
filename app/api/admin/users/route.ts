...
import { isFirebaseAdminConfigured, listAdminUsers } from "@/lib/adminData";
...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({ users: await listAdminUsers(request.nextUrl.searchParams.get("q") ?? "") });
}
